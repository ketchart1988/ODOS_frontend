        ...
        <div className="id= คุณสมบัติ">
          <div className="h-screen flex flex-col  ">
            ...
            <ul className="คุณสมบัติ px-6">
              ...
              <li><label htmlFor="#">A: ไม่ตรงตามคุณสมบัติ เนื่องจากจำเป็นต้องเป็นผู้ที่ศึกษาอยู่ในชั้นมันธยมปลาย (ม.4) หรือ ประกาศนียบัตรวิชาชีพ (ปวช.ปี 1) หรือมีใบมอบตัวอย่างเป็นทางการ ภายในปีการศึกษา 2567</label></li>
              <br />
              ...
              <li><label htmlFor="#"></label>A: สามารถใช้ผลการเรียนปี 1 ภาคการศึกษา 1 และผลการเรียนในเทอมก่อนหน้า เช่น ม.6 ภาคการศึกษา 2 ได้ แต่ถ้าผลการเรียนเทอม 2 ออกในช่วงเวลาของการเปิดรับสมัคร (เปิดรับสมัครถึง 16 พ.ค. 2568) สามารถรอผลของเทอม 2 ออกก่อนแล้วยื่นเอกสารโดยใช้ผลการเรียนปี 1 ทั้งเทอม 1 และ 2 ได้</li>
              <br />
