      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 ">
        <div className="text-center" >
          ...
          <RegionButton
            ...
            countryCode={"USA"}
            imageArray={["/images/04_USA.JPG", "/images/04_USA.JPG"]}
          />
        </div>
        ...
        <div className="text-center" >
          <p className="text-2xl sm:text-3xl font-bold ">Europe</p>
              <RegionButton
                handleModal={openModal}
                countryCode={"UK"}
                imageArray={["/images/uk_placeholder.JPG"]}
              />
          
              <RegionButton
                handleModal={openModal}
                countryCode={"Sweden"}
                imageArray={["/images/sweden_placeholder.JPG"]}
              />
            
              <RegionButton
                handleModal={openModal}
                countryCode={"Finland"}
                imageArray={["/images/finland_placeholder.JPG"]}
              />
        ...
        <div className="text-center" >
          ...
          <RegionButton
            handleModal={openModal}
            countryCode={"Japan"}
            imageArray={["/images/02_JAP.JPG", "/images/03_Estonia.JPG"]}
          />
        
          <RegionButton
            handleModal={openModal}
            countryCode={"Korea"}
            imageArray={["/images/korea_placeholder.JPG"]}
          />
        
          <RegionButton
            handleModal={openModal}
            countryCode={"Singapore"}
            imageArray={["/images/singapore_placeholder.JPG"]}
          />
        
          <RegionButton
            handleModal={openModal}
            countryCode={"Taiwan"}
            imageArray={["/images/taiwan_placeholder.JPG"]}
          />
        </div>
      </div>
